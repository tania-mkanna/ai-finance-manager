...
CREATE INDEX IF NOT EXISTS idx_budgets_user_category_dates
...
CREATE INDEX IF NOT EXISTS idx_receipts_user_status_uploaded_at
    ON receipts (user_id, status, uploaded_at DESC);

CREATE INDEX IF NOT EXISTS idx_receipt_items_receipt_id
    ON receipt_items (receipt_id);

CREATE INDEX IF NOT EXISTS idx_receipt_items_category_id
